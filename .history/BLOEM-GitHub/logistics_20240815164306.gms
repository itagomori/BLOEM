...
Parameters
    ...
    mxdisbe(c,cn)            'distance between grid cells'  # [km]
    ...
    flagmxbmt(c,cn)        'flag to determine logistic interconnections for biomass' # [binary, 0:1]

    flagmxenout(c,cn)    'flag to determine logistic interconnections for biofuels to consumer centers' # [binary, 0:1]

    flagmxenin(cn,c)     'flag to determine logistic interconnections for biofuels to consumer centers' # [binary, 0:1]
