...
Parameters
    ...
    mxccs(c,cn)          'distance between ccs cites c and grid cell cn'

    flagccout(c,cn)       'flag to determine logistic interconnections from carbon source to carbon sink' # [binary, 0/1]
