...
Parameters
    ...
    mmx(c, cm)          'maritime distance between grid cells' # [km]

    mx(cm,cn)           'distance between grid cells' # [km]
...
* Set biomass and biofuels transportation variable maritime costs varMtrco(r)

Parameter varMtrco(r) / foresres               0.0032 /;
;

* Set biomass and biofuels transportation fixed maritime costs fixMtrco(r)

Parameter fixMtrco(r) / foresres               0.0032 /;
;
...
Equations 
    ...
    impactroadbiotransport(t)        ''
    impactbiomaritimetransport(t)    ''
...
impactroadbiotransport(t) ..                      IRBT(t) =e= dfa(t)*sum((r,c,cn),trco(r)$(rres(r))*Bn(r,c,cn,t)$(rres(r))*mx(cm,cn)*tal(c)) ;

impactbiomaritimetransport(t) ..                  IMBT(t) =e= dfa(t)*sum((r,c,cn),(fixMtrco(r)$(rres(r))*Bn(r,c,cn,t)$(rres(r)))+(varMtrco(r)$(rres(r))*Bn(r,c,cn,t)$(rres(r))*mmx(c,cm)*tal(c))) ;
